'use client'
import LoadingGameIndex from './loading';
      ...
      <div data-testid="game-index" className={"flex flex-col items-center justify-start min-h-screen"}>
        <Header
          ...
          {showMenuItem === "navbar" && <Menu setShowMenuItem={(arg) => setShowMenuItem(arg)}/>}
                    ...
                    {showMenuItem === "hints" && <Hints foundWords={foundWords} validLetters={data.validLetters} centerLetter={data.centerLetter} setShowMenuItem={(arg) => setShowMenuItem(arg)} pangrams={data.pangrams} answers={data.answers} />}
          ...
          <div className="flex flex-col md:w-1/2 w-full md:px-2 items-center">
            ...
            <WordList answers={data.answers} pangrams={data.pangrams} words={foundWords}/>
          </div>
          <InputIndex 
