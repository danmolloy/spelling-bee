...
export default function Hexagon(props: HexagonProps) {
  ...
  return (
    <div data-testid="hexagon-div" /* disabled={letter === undefined ? true : false} */ className={letter ? " hex active:scale-90 active:border-gray-50 my-16 rounded-full " : "pulse hex active:scale-90 active:border-gray-50 my-16 rounded-full"}  onClick={() => setLetter(letter)}>
