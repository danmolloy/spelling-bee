...
export default function WordList(props: WordListProps) {
  ...
  return (
    <div data-testid="word-list" 
      className={showList 
      ? "w-[96vw] md:w-2/5 bg-white absolute z-30 border rounded-lg p-3 justify-between items-center font-light flex flex-col flex-wrap mt-10 transition-all duration-300" 
      : "w-[96vw] md:w-2/5 bg-white absolute z-30 border rounded-lg p-3 flex flex-row justify-between items-center font-light mt-10 transition-all duration-300"}>
      {isLoading 
